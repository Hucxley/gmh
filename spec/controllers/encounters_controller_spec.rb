...
describe EncountersController do
  ...
  def mock_encounter(stubs={})
    @mock_encounter ||= mock_model(Encounter, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all encounters as @encounters" do
      Encounter.stub(:all) { [mock_encounter] }
      get :index
      assigns(:encounters).should eq([mock_encounter])
    end
  end

  describe "GET show" do
    it "assigns the requested encounter as @encounter" do
      Encounter.stub(:find).with("37") { mock_encounter }
      get :show, :id => "37"
      assigns(:encounter).should be(mock_encounter)
    end
  end

  describe "GET new" do
    it "assigns a new encounter as @encounter" do
      Encounter.stub(:new) { mock_encounter }
      get :new
      assigns(:encounter).should be(mock_encounter)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created encounter as @encounter" do
        Encounter.stub(:new).with({'these' => 'params'}) { mock_encounter(:save => true) }
        post :create, :encounter => {'these' => 'params'}
        assigns(:encounter).should be(mock_encounter)
      end

      it "redirects to the created encounter" do
        Encounter.stub(:new) { mock_encounter(:save => true) }
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved encounter as @encounter" do
        Encounter.stub(:new).with({'these' => 'params'}) { mock_encounter(:save => false) }
        post :create, :encounter => {'these' => 'params'}
        assigns(:encounter).should be(mock_encounter)
      end

      it "re-renders the 'new' template" do
        Encounter.stub(:new) { mock_encounter(:save => false) }
        post :create, :encounter => {}
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested encounter" do
        Encounter.should_receive(:find).with("37") { mock_encounter }
        mock_encounter.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => "37", :encounter => {'these' => 'params'}
      end

      it "assigns the requested encounter as @encounter" do
        Encounter.stub(:find) { mock_encounter(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:encounter).should be(mock_encounter)
      end
    ...
    describe "with invalid params" do
      it "assigns the encounter as @encounter" do
        Encounter.stub(:find) { mock_encounter(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:encounter).should be(mock_encounter)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the encounters list" do
      Encounter.stub(:find) { mock_encounter(:destroy => true) }
      delete :destroy, :id => "1"
